...
namespace gamerpilotPlatform.Migrations
{
    ...
    [Migration("20181111153929_gamertest")]
    partial class gamertest
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("gamerpilotPlatform.Model.GamerProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("gamerpilotPlatform.Model.TestResults", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int?>("GamerProfileId");

                    b.HasKey("Id");

                    b.HasIndex("GamerProfileId");
            ...
            modelBuilder.Entity("gamerpilotPlatform.Model.TestResults", b =>
                {
                    b.HasOne("gamerpilotPlatform.Model.GamerProfile", "GamerProfile")
                        .WithMany()
                        .HasForeignKey("GamerProfileId");
                });
